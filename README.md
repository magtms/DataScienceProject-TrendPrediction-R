# DataScienceProject-TrendPrediction-R

The repository contains a data science project with target business objectives of Company A. Topic focusing on the issue (or bugs) raised from the company's operation systems, key objectives of the project is to:
...
1. Data exploration, mining and preprocessing
